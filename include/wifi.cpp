...
void wifiTryOTAUpdate() {
    Serial.println("Getting OTA info");
    auto inf = OTADRIVE.updateFirmwareInfo();
    Serial.println("Got OTA info");

    if (inf.available) {
        Serial.print("New firmware version available: ");
...
void wifiOnOTAUpdateProgress(int progress, int totalt) {
  static int last = 0;
